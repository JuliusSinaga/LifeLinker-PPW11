...
export default function NotFoundPage({ type = "404" }) {
  ...
  const content = {
    ...
    500: {
      ...
      message:
        "Maaf, server kami sedang mengalami gangguan. Silakan coba beberapa saat lagi.",
  ...
  return (
    <div className="error-page-root">
      <div className="error-container">
        <div className="error-visual">{currentError.icon}</div>
        ...
        <div className="error-actions">
          ...
          <button
            onClick={() =>
              window.history.length > 1 ? navigate(-1) : navigate("/beranda")
            }
            className="btn-back"
          >
            <FaArrowLeft /> Kembali
